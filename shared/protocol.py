...
CMD_REQUEST_FORUM_KEY = "REQUEST_FORUM_KEY"
...
# --- Comandos do mesh P2P (modo LAN, peer <-> peer direto, sem servidor) ------

CMD_MESH_HANDSHAKE = "MESH_HANDSHAKE"
CMD_MESH_MESSAGE = "MESH_MESSAGE"
...
EVT_KEY_REQUESTED = "KEY_REQUESTED"
